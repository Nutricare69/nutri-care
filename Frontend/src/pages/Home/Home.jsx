  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen  w-full bg-[#A6D4AC]/40">
        ...
        <div className="grow flex flex-col w-full pb-10 overflow-x-hidden">
          {/* 
            NAVBAR WRAPPER FIXED:
            Removed 'max-w-[1400px]' and 'mx-auto'. Now the navbar container wrapper stretches 
            100% fluidly across your screen, giving the internal floating pill full layout freedom!
          */}
            <Navbar/>

          <Hero />

          {/* Core Features Section (Kept centered for solid grid spacing layouts) */}
              ...
              <div className="w-full mt-8 sm:mt-10 flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
                ...
                >
                  ...
                  >
                    <img
                      src={ScienceBacked}
                      alt="Science-Backed AI Nutrition"
