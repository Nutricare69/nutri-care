...
export default function Dashboard() {
  ...
  // Wait a few seconds after load, then show the prompt if they aren't premium
  useEffect(() => {
    let timer;
    if (userData && !userData.isPremium && !hasPromptedPremium && !loading) {
      // Show popup 3 seconds after dashboard loads
      timer = setTimeout(() => {
        setShowPremiumPrompt(true);
        setHasPromptedPremium(true); //global flag to prevent showing again during this app lifecycle
      }, 3000);
    }
